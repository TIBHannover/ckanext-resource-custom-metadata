...
$(document).ready(function(){
    ...
    $(document).on('shown.bs.modal', '.resource-custom-metadata-modal', function () {
        let id = $(this).attr('id');
     ...
     * 
     */
    $(document).on('click', '[data-remove-metadata-row]', function(e){
        e.preventDefault();
        let row = $(this).closest('[data-metadata-row]');
        let checkBoxes = row.find('.resource-box');
     ...
     * 
     */
     $(document).on('click', '.select-all-resources', function(){
        let id = $(this).attr('id');
     ...
     */
      ...
      $(document).on('click', '.resource-box', function(){
     ...
     * 
     */
    $(document).on('click', '.res_custom_metadat_modal_save', function(){
